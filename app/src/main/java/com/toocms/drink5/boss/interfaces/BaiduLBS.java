...
public class BaiduLBS {
    ...
    public void search(String query, String city, ApiListener apiListener) {
        ...
        String utl = http + "q=" + URLEncoder.encode(query) + "&region=" + URLEncoder.encode(city) + "&output=json&ak=ggLPgdLDaLpmQFKa0cfX5SIDc1qIV78N&mcode=9C:76:7A:02:C8:26:46:A1:48:85:C2:0D:80:29:AA:DE:90:19:9D:51;com.toocms.drink5.boss";
...
//        params.addQueryStringParameter("mcode", "9C:76:7A:02:C8:26:46:A1:48:85:C2:0D:80:29:AA:DE:90:19:9D:51;com.toocms.drink5.boss");
    ...
    public void search2(String address, ApiListener apiListener) {
        ...
        String url = "http://api.map.baidu.com/geocoder/v2/?ak=BgQunBgke6Zrs0Oo1R5SXGriF1MtPN2D&mcode=9C:76:7A:02:C8:26:46:A1:48:85:C2:0D:80:29:AA:DE:90:19:9D:51;com.toocms.drink5.boss&location=" + address + "&output=json";
